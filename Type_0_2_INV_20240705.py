...
BTC_0_dic = {'type': 'type_0', 'coin_No': 0, 'coin_Name': 'KRW-BTC', 'ma_duration_long': 69, 'ma_duration_mid': 23, 'ma_duration_short': 5, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0005, 'recent_ratio_ema_long_plus': 0.0002, 'successive_rise': 7, 'ratio_ema_mid_long': 0.98, 'ref_vol_duration': 3, 'diff_m_l_factor': 0, 'coe_vol_comp': 1.0, 'under_long_duration': 17, 'compare_dura_buy': 45, 'sell_method_vol_cri': 0.2, 'sell_ma_duration_1': 68, 'ratio_peak_diff': 0.88, 'ratio_sell_ema_mid': 0.999, 'ratio_std_1': 0.1, 'ratio_std_2': 0.05, 'continuous_fall': 7, 'continuous_fall_ratio': 2.1, 'ratio_sell_forced': 0.03, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

ETH_1_dic = {'type': 'type_0', 'coin_No': 0, 'coin_Name': 'KRW-ETH', 'ma_duration_long': 69, 'ma_duration_mid': 44, 'ma_duration_short': 19, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0005, 'recent_ratio_ema_long_plus': 0.0, 'successive_rise': 12, 'ratio_ema_mid_long': 0.98, 'ref_vol_duration': 3, 'diff_m_l_factor': -0.002, 'coe_vol_comp': 1.5, 'under_long_duration': 19, 'compare_dura_buy': 12, 'sell_method_vol_cri': 0.3, 'sell_ma_duration_1': 47, 'ratio_peak_diff': 0.84, 'ratio_sell_ema_mid': 0.998, 'ratio_std_1': 0.03, 'ratio_std_2': 0.03, 'continuous_fall': 7, 'continuous_fall_ratio': 1.2, 'ratio_sell_forced': 0.065, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}
 
STEEM_11_dic = {'type': 'type_0', 'coin_No': 0, 'coin_Name': 'KRW-STEEM', 'ma_duration_long': 70, 'ma_duration_mid': 39, 'ma_duration_short': 7, 'ratio_ema_long_rise': 1.0002, 'ratio_ema_mid_rise': 1.0005, 'recent_ratio_ema_long_plus': 0.0, 'successive_rise': 13, 'ratio_ema_mid_long': 0.99, 'ref_vol_duration': 1, 'diff_m_l_factor': -0.002, 'coe_vol_comp': 0.5, 'under_long_duration': 26, 'compare_dura_buy': 16, 'sell_method_vol_cri': 0.3, 'sell_ma_duration_1': 85, 'ratio_peak_diff': 0.8, 'ratio_sell_ema_mid': 0.998, 'ratio_std_1': 0.0, 'ratio_std_2': 0.0, 'continuous_fall': 7, 'continuous_fall_ratio': 1.6, 'ratio_sell_forced': 0.085, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}


# Type_2

ETC_5_dic = {'type': 'type_2', 'coin_No': 'KRW-ETC', 'coin_Name': 'KRW-ETC', 'ma_duration_long': 101, 'ma_duration_mid': 30, 'ma_duration_short': 74, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 47, 'recent_vol_duration': 9, 'compare_dura_buy': 28, 'sell_method_vol_cri': 0.1, 'ratio_peak_diff': 0.74, 'ratio_open_check': 1.0027, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.996, 'ratio_mean_long': 0.5, 'continuous_fall': 8, 'continuous_fall_ratio': 1.0, 'ratio_sell_forced': 0.07, 'bought_state': 0, 'bought_price': 0.0}

BTG_20_dic = {'type': 'type_2', 'coin_No': 'KRW-BTG', 'coin_Name': 'KRW-BTG', 'ma_duration_long': 102, 'ma_duration_mid': 34, 'ma_duration_short': 56, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0001, 'successive_rise': 7, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 1.0, 'under_long_duration': 20, 'recent_vol_duration': 9, 'compare_dura_buy': 14, 'sell_method_vol_cri': 2.5, 'ratio_peak_diff': 0.74, 'ratio_open_check': 1.0035, 'ratio_reduced': 0.8, 'ratio_prior_to_cur_long': 0.994, 'ratio_mean_long': 0.1, 'continuous_fall': 6, 'continuous_fall_ratio': 0.7, 'ratio_sell_forced': 0.11, 'bought_state': 0, 'bought_price': 0.0}

ARK_14_dic = {'type': 'type_2', 'coin_No': 'KRW-ARK', 'coin_Name': 'KRW-ARK', 'ma_duration_long': 89, 'ma_duration_mid': 26, 'ma_duration_short': 65, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 45, 'recent_vol_duration': 13, 'compare_dura_buy': 43, 'sell_method_vol_cri': 2.5, 'ratio_peak_diff': 0.75, 'ratio_open_check': 1.0029, 'ratio_reduced': 1.0, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.1, 'continuous_fall': 8, 'continuous_fall_ratio': 1.4, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}

WAXP_57_dic = {'type': 'type_2', 'coin_No': 'KRW-WAXP', 'coin_Name': 'KRW-WAXP', 'ma_duration_long': 102, 'ma_duration_mid': 21, 'ma_duration_short': 65, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0, 'successive_rise': 5, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 48, 'recent_vol_duration': 8, 'compare_dura_buy': 36, 'sell_method_vol_cri': 2.5, 'ratio_peak_diff': 0.68, 'ratio_open_check': 1.0017, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.7, 'continuous_fall': 7, 'continuous_fall_ratio': 3.0, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

QTUM_9_dic = {'type': 'type_2', 'coin_No': 'KRW-QTUM', 'coin_Name': 'KRW-QTUM', 'ma_duration_long': 89, 'ma_duration_mid': 33, 'ma_duration_short': 76, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0002, 'successive_rise': 12, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 47, 'recent_vol_duration': 9, 'compare_dura_buy': 27, 'sell_method_vol_cri': 3.0, 'ratio_peak_diff': 0.68, 'ratio_open_check': 1.0035, 'ratio_reduced': 0.9, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.2, 'continuous_fall': 7, 'continuous_fall_ratio': 1.6, 'ratio_sell_forced': 0.085, 'bought_state': 0, 'bought_price': 0.0}

BORA_72_dic = {'type': 'type_2', 'coin_No': 'KRW-BORA', 'coin_Name': 'KRW-BORA', 'ma_duration_long': 101, 'ma_duration_mid': 32, 'ma_duration_short': 60, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0001, 'successive_rise': 11, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 8, 'recent_vol_duration': 9, 'compare_dura_buy': 11, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.68, 'ratio_open_check': 1.004, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.1, 'continuous_fall': 10, 'continuous_fall_ratio': 0.9, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}
...
def type_0_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 0 :   # 매수가 없는 상태라면 
        ...
        DF_check.loc[(DF_check['ratio_prior_to_cur'] <= 1), 'fall_check'] = 1
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        DF_check_peak['fall_check'] = 0
        DF_check_peak.loc[(DF_check_peak['ratio_prior_to_cur'] <= 1), 'fall_check'] = 1
        ...
        if (time_elapse_bought > 1) and         (DF_check_peak.iloc[-(target_dic['continuous_fall'] + 1) : ]['fall_check'].sum() >= target_dic['continuous_fall']) and (DF_check_peak['fall_check'][-1] == 1) and         ((DF_check_peak['low'][-1] / DF_check_peak['open'][-(target_dic['continuous_fall'] + 1)]) < (1 - (target_dic['continuous_fall_ratio'] * target_dic['ratio_sell_forced']))) :
            
            transaction_sell = upbit.sell_market_order(target_coin, get_balance(target_coin[4:]))  # 시장가에 매도
            time.sleep(5)
            print('\nnow :', (datetime.datetime.now() + datetime.timedelta(seconds=(time_factor * 3600))))
            print('sell_transaction_result_by_Continuous_fall :', transaction_sell)
